...
public class PlayerCharacterController : MonoBehaviour
{
    ...
    [Tooltip("Reference to HandMovementController")]
    ...
    void Start()
    {
        ...
        if (HandMovementController == null)
        {
            Debug.LogError("HandMovementController is not assigned in the PlayerCharacterController");
        }
        ...
        bool isSprinting = m_InputHandler.GetSprintInputHeld();
        {
            ...
            if (IsGrounded)
            {
                ...
                if (IsGrounded && m_InputHandler.GetJumpInputDown())
                {
                    ...
                    if (HandMovementController != null)
                    {
                        HandMovementController.TriggerHandMovement();
                    }
                }
